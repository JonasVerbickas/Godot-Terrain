...
var source_vertex = FileAccess.get_file_as_string("res://Scripts/vertex.glsl")
var source_fragment = FileAccess.get_file_as_string("res://Scripts/source.glsl")
var source_wire_fragment = FileAccess.get_file_as_string("res://Scripts/wireframe.glsl")
